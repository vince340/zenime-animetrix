...
function CategoryCardLoader({ className, showLabelSkeleton = true }) {
    return (
        <div className={`w-full ${className}`}>
            {showLabelSkeleton && <Skeleton className="w-[200px] h-[20px] max-[320px]:w-[70px]" />}
                ...
                {[...Array(12)].map((_, index) => (
                    <div
                        ...
                        <div className='w-full relative'>
                            <Skeleton
                                className="w-full h-[250px] object-cover max-[1200px]:h-[35vw] max-[758px]:h-[45vw] max-[478px]:h-[60vw] rounded-none"
                            />
